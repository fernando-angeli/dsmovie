...
import com.fernandoangeli.dsmovie.repositories.ScoreRepository;
import com.fernandoangeli.dsmovie.repositories.UserRepository;
...
public class ScoreService {
    ...
    public MovieDTO saveScore(ScoreDTO dto){
        ...
        Movie movie = movieRepository.findById(dto.getMovie_id()).get();
